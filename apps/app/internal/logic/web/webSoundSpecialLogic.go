...
type WebSoundSpecialLogic struct {
	logx.Logger
	ctx    context.Context
	svcCtx *svc.ServiceContext
}

func NewWebSoundSpecialLogic(ctx context.Context, svcCtx *svc.ServiceContext) *WebSoundSpecialLogic {
	return &WebSoundSpecialLogic{
...
func (l *WebSoundSpecialLogic) WebSoundSpecial(req *types.Req) (resp *types.ShortRecPositionResp, err error) {
